...
#' @return Creates an object of class \code{RootDepSet} with two empty slots \code{$value} and \code{$root}.
#' @export
#' @examples
#' rdsobj<- RootDepSet()
...
#' @return An object with two empty slots \code{$value} for the collection of subsets and \code{$root}
#' @export
#' @examples
...
#' @return An object with two empty slots \code{$value} for the collection of subsets of nodes
#' and \code{$root} for the roots.
#' @export
#' @examples
...
#' @return  An object with two empty slots \code{$value} for the collection of subsets and \code{$root} for the roots.
#' @export Set
#' @examples
#' myset<- Set()
Set<- function()
